...
//     const [lastPage, setLastPage] = useState(1);
//     const [editingRecord, setEditingRecord] = useState(null);
//     const [allFilteredData, setAllFilteredData] = useState([]); // Store all filtered data for PDF
//     const [filters, setFilters] = useState({
//         head: '',
//         program: '',
//         project: '',
...
//     const fetchSummary = async () => {
//         try {
//             const response = await axios.get(`${API_BASE_URL}/budget/summary`, axiosConfig);
//             if (response.data.success) {
//                 setTotalBudget(response.data.data.total_budget || 0);
//             }
//         } catch (error) {
...
//         setLoading(true);
//         try {
//             const response = await axios.get(`${API_BASE_URL}/budget/export`, axiosConfig);
...
//                                         <td>${record.subproj}</td>
//                                         <td>${record.object}</td>
//                                         <td>${record.objname}</td>
//                                         <td style="text-align: right;">${record.amount.toLocaleString('en-US', { minimumFractionDigits: 2 })}</td>
//                                     </tr>
//                                 `).join('')}
//                             </tbody>
//                         </table>
...
//     };
//     // <div class="total">
//     //     Total Records: ${exportData.length-1} | Total Budget: Rs${filteredTotal.toLocaleString('en-US', { minimumFractionDigits: 2 })}
//     // </div>
//     // Handle edit button click
//     const handleEdit = (record) => {
//         setEditingRecord({
...
//                                             />
//                                         </td>
//                                         <td className="px-4 py-3 text-sm text-gray-900">{record.original?.head || '-'}</td>
//                                         <td className="px-4 py-3 text-sm text-gray-900">{record.original?.program || '-'}</td>
//                                         <td className="px-4 py-3 text-sm text-gray-900">{record.original?.project || '-'}</td>
//                                         <td className="px-4 py-3 text-sm text-gray-900">{record.original?.subproj}</td>
//                                         <td className="px-4 py-3 text-sm text-gray-900">{record.original?.object}</td>
//                                         <td className="px-4 py-3 text-sm text-gray-900">{record.departmentName}</td>
//                                         <td className="px-4 py-3 text-sm text-right font-medium">{record.budget.toLocaleString('en-US', { minimumFractionDigits: 2 })}</td>
//                                         <td className="px-4 py-3 text-center">
//                                             <button
