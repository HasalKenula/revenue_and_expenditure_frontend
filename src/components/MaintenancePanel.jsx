    ...
    try {
      ...
      if (response.data.success) {
        ...
        if (csvData.length > 0) {
          ...
          a.href = url;
          a.download = `allocation_balance_report_${appliedFilters.year}_${monthNames[appliedFilters.month]}.csv`;
          a.click();
            ...
            <table className="w-full text-sm border-collapse">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-4 py-3 text-right font-semibold text-gray-700 border border-gray-300">Expenditure (Rs)</th>
                  <th className="px-4 py-3 text-right font-semibold text-gray-700 border border-gray-300">Balance (Rs)</th>
                </tr>
              </thead>
              <tbody>
                {!appliedFilters.year || !appliedFilters.month ? (
                  ...
                  paginatedRecords.map((record, index) => {
                    ...
                    return (
                      ...
                      >
                        <td className={`px-4 py-3 border border-gray-300 ${isGrandTotal ? 'text-gray-700' : 'text-gray-700'}`}>
                          {record.name || '-'}
                        </td>
                        ...
                        <td className={`px-4 py-3 text-right font-medium border border-gray-300 ${parseFloat(record.balance) >= 0 ? 'text-gray-600' : 'text-gray-600'
                          }`}>
                          {formatNumber(record.balance)}
                        </td>
                      </tr>
