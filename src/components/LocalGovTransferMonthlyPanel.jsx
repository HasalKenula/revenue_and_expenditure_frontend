          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  <th className="px-4 py-3 text-left font-semibold text-gray-700 sticky left-0 bg-gray-50 border border-gray-300">Month</th>
                  <th className="px-4 py-3 text-right font-semibold text-gray-700 border border-gray-300">Salary Reimbursement (306-3-2-0-1503)(Rs)</th>
                  <th className="px-4 py-3 text-right font-semibold text-gray-700 border border-gray-300">Members Allowances (306-3-2-0-1503)(Rs)</th>
