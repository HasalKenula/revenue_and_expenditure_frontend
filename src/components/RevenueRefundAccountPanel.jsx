...
const RevenueRefundAccountPanel = () => {
    ...
    const fetchRecords = async () => {
        ...
        try {
            ...
            const response = await apiClient.get('/revenue-refund-account/data', { params });
    ...
    const fetchFilterOptions = async () => {
        try {
            const response = await apiClient.get('/revenue-refund-account/filter-options');
    ...
    const handleExportPDF = () => {
        ...
        try {
            ...
            doc.text('Revenue Refund Account Report', pageWidth / 2, 15, { align: 'center' });
            ...
            autoTable(doc, {
                ...
                didParseCell: function (data) {
                    ...
                    if (data.section === 'body' && data.row.index === table1Body.length - 1) {
            ...
            autoTable(doc, {
                ...
                alternateRowStyles: { fillColor: [245, 245, 245] },
                margin: { top: 35, left: 18.5, right: 43.5 },
                tableWidth: 'auto',
                didParseCell: function (data) {
                    // Check if this is the last row (total row)
                    if (data.section === 'body' && data.row.index === table1Body.length - 1) {
            ...
            // Save PDF
            doc.save(`revenue_refund_account_${appliedFilters.year}.pdf`);
    ...
    const handleExportCSV = async () => {
        ...
        try {
            ...
            const response = await apiClient.get('/revenue-refund-account/export-csv', { params });
            ...
            if (response.status === 200) {
                ...
                a.href = url;
                a.download = `revenue_refund_account_${appliedFilters.year}.csv`;
                a.click();
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <div className="flex justify-between items-start">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-800">Revenue Refund Account Report</h1>
                        <p className="text-sm text-gray-500 mt-1">
                            View revenue refund by month with classification (Monthly Fincances - dr_cr_code=5000, dr_cr=DR)
                        </p>
                    </div>
                    {appliedFilters.year && (
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-xl w-full max-w-md p-6 shadow-xl">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="text-lg font-semibold text-gray-800">Filter Revenue Refund Account</h3>
                            <button
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="text-xs text-gray-500 mt-1">
                                    Shows revenue refund data for all 12 months
                                </p>
                            </div>
...
export default RevenueRefundAccountPanel;