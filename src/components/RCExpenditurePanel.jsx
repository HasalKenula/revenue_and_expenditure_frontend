          ...
          <div className="overflow-x-auto">
            <table className="w-full text-xs border-collapse">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  <th className="px-2 py-3 text-left font-semibold text-gray-700 sticky left-0 bg-gray-50 min-w-[60px] border border-gray-300">Head</th>
                  {categoryLabels.map((label, index) => (
                    <th key={index} className="px-2 py-3 text-right font-semibold text-gray-700 min-w-[100px] border border-gray-300">
                ...
                {!appliedFilters.year ? (
                  ...
                  paginatedRecords.map((record, index) => {
                    ...
                    return (
                      ...
                      >
                        <td className={`px-2 py-2 font-medium sticky left-0 bg-white border border-gray-300 ${isTotalRow ? 'bg-gray-100' : ''}`}>
                        ...
                        {categoryKeys.map((key) => {
                          ...
                          return (
                            <td key={key} className={`px-2 py-2 text-right border border-gray-300 ${isTotalRow ? 'text-gray-600' : 'text-gray-900'}`}>
                              {formatNumber(value)}
                            </td>
                          );
                        })}
