                    ...
                    <table className="w-full text-sm">
                        <thead className="bg-gray-50 border-b border-gray-200">
                            <tr>
                                ...
                                <th className="px-4 py-3 text-right font-semibold text-gray-700">FR 30 P (Rs)</th>
                                <th className="px-4 py-3 text-right font-semibold text-gray-700">FR 30 M (Rs)</th>
