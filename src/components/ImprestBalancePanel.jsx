          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  <th className="px-4 py-3 text-left font-semibold text-gray-700 border border-gray-300">Head</th>
                  <th className="px-4 py-3 text-right font-semibold text-gray-700 border border-gray-300">Opening Balance</th>
                  <th className="px-4 py-3 text-right font-semibold text-gray-700 border border-gray-300">DR Amount</th>
                  <th className="px-4 py-3 text-right font-semibold text-gray-700 border border-gray-300">Issue Amount</th>
                  <th className="px-4 py-3 text-right font-semibold text-gray-700 border border-gray-300">CR Amount</th>
                  <th className="px-4 py-3 text-right font-semibold text-gray-700 border border-gray-300">Settle Amount</th>
                  <th className="px-4 py-3 text-right font-semibold text-gray-700 border border-gray-300">Grand Total</th>
                </tr>
              </thead>
              <tbody>
                {!appliedFilters.year || !appliedFilters.month ? (
                  ...
                  paginatedRecords.map((record, index) => (
                    <tr key={index} className="border-b border-gray-100 hover:bg-gray-50 transition">
                      <td className="px-4 py-3 font-medium text-gray-900 border border-gray-300">{record.trno || '-'}</td>
                      <td className="px-4 py-3 text-right text-gray-700 border border-gray-300">{formatNumber(record.opening_balance)}</td>
                      <td className="px-4 py-3 text-right text-gray-600 border border-gray-300">{formatNumber(record.dr_amount)}</td>
                      <td className="px-4 py-3 text-right text-gray-600 border border-gray-300">{formatNumber(record.issue_amount)}</td>
                      <td className="px-4 py-3 text-right text-gray-600 border border-gray-300">{formatNumber(record.cr_amount)}</td>
                      <td className="px-4 py-3 text-right text-gray-600 border border-gray-300">{formatNumber(record.settle_amount)}</td>
                      <td className="px-4 py-3 text-right font-bold border border-gray-300 text-gray-700">
                        {formatNumber(record.grand_total)}
                      </td>
                    </tr>
                  ))
              ...
              {paginatedRecords.length > 0 && (
                <tfoot className="bg-gray-50 border-t border-gray-200">
                  <tr className="font-semibold">
                    <td className="px-4 py-3 text-right font-bold text-gray-700 border border-gray-300">GRAND TOTAL:</td>
                    <td className="px-4 py-3 text-right text-gray-700 border border-gray-300">{formatNumber(grandTotals.total_opening_balance)}</td>
                    <td className="px-4 py-3 text-right text-gray-700 border border-gray-300">{formatNumber(grandTotals.total_dr)}</td>
                    <td className="px-4 py-3 text-right text-gray-700 border border-gray-300">{formatNumber(grandTotals.total_issue)}</td>
                    <td className="px-4 py-3 text-right text-gray-700 border border-gray-300">{formatNumber(grandTotals.total_cr)}</td>
                    <td className="px-4 py-3 text-right text-gray-700 border border-gray-300">{formatNumber(grandTotals.total_settle)}</td>
                    <td className="px-4 py-3 text-right font-bold border border-gray-300 text-gray-700">
