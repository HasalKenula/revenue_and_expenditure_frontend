...
const ImprestBalancePanel = () => {
  ...
  //     // Description
  //     doc.setFontSize(10);
  //     doc.text('DEBITS', 20, 50);
  //     doc.setFontSize(10);
  //     doc.text('Balance of previous year:', 20, 50);
  //     doc.setFontSize(10);
  //     doc.text('Imprest issued so far:', 20, 50);
  //     doc.setFontSize(10);
  //     doc.text('Debits from monthly Summary:', 20, 50);
  //     doc.setDrawColor(200, 200, 200);
  //     doc.line(15, 40, pageWidth - 15, 40);
  //     doc.setFontSize(10);
  //     doc.text('Sub Total:', 20, 50);

  //     doc.setFontSize(10);
  //     doc.text('CREDITS', 20, 50);

  //     doc.setFontSize(10);
  //     doc.text('Imprest settle so far:', 20, 50);
  //     doc.setFontSize(10);
  //     doc.text('Credits from monthly Summary:', 20, 50);
  //     doc.setDrawColor(200, 200, 200);
  //     doc.line(15, 40, pageWidth - 15, 40);
  //     doc.setFontSize(10);
  //     doc.text('Sub Total:', 20, 50);
  //     doc.setFontSize(10);
  //     doc.text('Grand Total:', 20, 50);
