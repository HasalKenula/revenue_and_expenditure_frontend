          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  <th className="px-4 py-3 text-left font-semibold text-gray-700 border border-gray-300">Name</th>
                  <th className="px-4 py-3 text-right font-semibold text-gray-700 border border-gray-300">Total Debits (Rs)</th>
                  <th className="px-4 py-3 text-right font-semibold text-gray-700 border border-gray-300">Total Credits (Rs)</th>
                </tr>
              </thead>
              <tbody>
                {!appliedFilters.year || !appliedFilters.month ? (
                      ...
                      if (account) {
                        ...
                        return (
                          <tr key={key} className="border-b border-gray-100 hover:bg-gray-50 transition">
                            <td className="px-4 py-3 text-gray-700 border border-gray-300">{account.label || key}</td>
                            <td className="px-4 py-3 text-right font-medium text-gray-600 border border-gray-300">
                              {formatNumber(account.debit || 0)}
                            </td>
                            <td className="px-4 py-3 text-right font-medium text-gray-600 border border-gray-300">
                              {formatNumber(account.credit || 0)}
                            </td>
                          </tr>
                        );
                      }
                      ...
                      <>
                        ...
                        {balanceDebit > 0 && (
                          <tr className="border-b border-gray-200">
                            <td className="px-4 py-3 text-gray-700 font-medium border border-gray-300">Balance (Debit)</td>
                            <td className="px-4 py-3 text-right font-medium text-gray-700 border border-gray-300">
                              {formatNumber(balanceDebit)}
                            </td>
                            <td className="px-4 py-3 text-right font-medium text-gray-700 border border-gray-300">
                              0.00
                            </td>
                        ...
                        {balanceCredit > 0 && (
                          <tr className="border-b border-gray-200">
                            <td className="px-4 py-3 text-gray-700 font-medium border border-gray-300">Balance (Credit)</td>
                            <td className="px-4 py-3 text-right font-medium text-gray-700 border border-gray-300">
                              0.00
                            </td>
                            <td className="px-4 py-3 text-right font-medium text-gray-700 border border-gray-300">
                              {formatNumber(balanceCredit)}
                            </td>
                          </tr>
                        )}
                        ...
                        <tr className="border-b border-gray-200 bg-gray-100 font-semibold">
                          <td className="px-4 py-3 text-gray-800 border border-gray-300">Total</td>
