      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-5 text-white shadow-lg">
          <div className="flex items-center justify-between">
            <p className="text-sm opacity-90">Total Transfer Amount</p>
            <Wallet size={20} className="opacity-80" />
          </div>
          <p className="text-2xl font-bold mt-2">Rs{formatNumber(totals.total_amount)}</p>
        </div>

        <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl p-5 text-white shadow-lg">
          <div className="flex items-center justify-between">
            <p className="text-sm opacity-90">Cumulative Expenditure</p>
            <TrendingUp size={20} className="opacity-80" />
          </div>
          <p className="text-2xl font-bold mt-2">Rs{formatNumber(totals.cumulative_total)}</p>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="px-4 py-3 text-right font-semibold text-gray-700">Total(Rs)</th>
                <th className="px-4 py-3 text-right font-semibold text-gray-700 bg-purple-50">Cumulative Expenditure(Rs)</th>
              </tr>
            </thead>
            <tbody>
              {!appliedFilters.year ? (
                ...
                paginatedData.map((record, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className={`px-4 py-3 text-right font-bold bg-purple-50 ${isTotal ? 'text-purple-700' : 'text-purple-600'
                        }`}>
                        {formatNumber(record.cumulative_expenditure || 0)}
                      </td>
                    </tr>
